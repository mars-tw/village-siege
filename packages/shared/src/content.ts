...
export const UNITS: Readonly<Record<UnitType, UnitDefinition>> = {
  ...
  mage: { id: "mage", cost: wallet(70, 0, 75), maxHitPoints: 55, attackDamage: 20, attackRange: 4, attackCooldownTicks: 18, speedMilliTilesPerSecond: 950, sightRadius: 8, population: 2, trainTicks: 240, producers: ["barracks"], gatherPerSecond: { food: 0, wood: 0, stone: 0 } },
  musketeer: { id: "musketeer", cost: wallet(70, 65, 20), maxHitPoints: 65, attackDamage: 24, attackRange: 5, attackCooldownTicks: 20, speedMilliTilesPerSecond: 920, sightRadius: 8, population: 2, trainTicks: 260, producers: ["barracks"], gatherPerSecond: { food: 0, wood: 0, stone: 0 } },
