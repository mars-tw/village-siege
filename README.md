...
- 戰前選單提供五種 AI 性格：進攻、守備、發展、平衡、襲擾；目前戰鬥展示尚未把選擇轉成實際布局與 AI 行為差異。
...
手機橫向操作（667×375 與 844×390 已驗證）：

- 第一次進入戰場會顯示三步操作說明；之後可從「更多 → 說明」再次開啟。
- 智慧指令下，點我軍選取、點地移動、點敵軍攻擊，拖曳空地可平移鏡頭。
- 底部單列指揮列提供全軍、移動、攻擊、技能、隊形、框選、移鏡與更多；編隊、重開及返回收在次級面板，不會和主命令重疊。
- 每個觸控按鈕為 54×56 CSS px；選村、多人房間與戰鬥畫面不需要頁面捲動。
...
- 公開單機主路徑目前是烽火台戰鬥展示，不是完整村莊攻防 RTS；尚無資源採集、人口、建造、生產、修理、戰爭迷霧、可破壞村莊或指揮中心勝負。
- 三村與五種 AI 的選項目前尚未改變 `CombatShowcaseScene` 的布局、經濟或決策，不可宣稱已具有三套村莊玩法或五種可量測 AI 行為。
